...
public class AdaptadorVideo1 extends RecyclerView.Adapter<AdaptadorVideo1.ViewHolderDatos> {
    ArrayList<TareasMedia>  lista;

    public AdaptadorVideo1(ArrayList<TareasMedia> lista) {
        this.lista = lista;
    }

    @NonNull
    @Override
    public AdaptadorVideo1.ViewHolderDatos onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.itmvideo,parent,false);
        return new ViewHolderDatos(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdaptadorVideo1.ViewHolderDatos holder, int position) {
