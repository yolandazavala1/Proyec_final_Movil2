...
public class Adaptadoraudio1 extends RecyclerView.Adapter<Adaptadoraudio1.ViewHolderDatos> {
    ArrayList<TareasMedia> listaaudio=new ArrayList<>();

    public Adaptadoraudio1(ArrayList<TareasMedia> listaaudio) {
